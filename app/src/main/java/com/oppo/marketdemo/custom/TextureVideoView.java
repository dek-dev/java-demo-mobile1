    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mVideoWidth > 0 && mVideoHeight > 0) {
            ...
            if (widthSpecMode == MeasureSpec.EXACTLY && heightSpecMode == MeasureSpec.EXACTLY) {
                ...
                Log.i(TAG, "width EXACTLY --> width = " + width + ", height = " + height);
                ...
                Log.i(TAG, "height EXACTLY --> width = " + width + ", height = " + height);
            } else {
...
//        else {
            ...
            Log.e(TAG, " width < 0 and height < 0");
//        }
    ...
    public void setVideoId(int id) {
        setVideoURI(Uri.parse("android.resource://" + getContext().getPackageName() + "/" + id));
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            mMediaPlayer.setOnSeekCompleteListener(mSookCompleteListener);
    ...
    MediaPlayer.OnSeekCompleteListener mSookCompleteListener = new MediaPlayer.OnSeekCompleteListener() {
        @Override
...
//            });
    ...
    private int mediaPlayerSeekType = -1;
    public void setMediaPlayerSeekType(int type){
        mediaPlayerSeekType = type;
    }
    ...
    public void seekTo(int msec) {
        if (isInPlaybackState()) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                if (mediaPlayerSeekType >= 0 && mediaPlayerSeekType <= 3){
                    mMediaPlayer.seekTo(msec, mediaPlayerSeekType);
                }else {
